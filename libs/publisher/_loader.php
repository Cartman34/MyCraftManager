...
addAutoload('AbstractPublication',				'publisher/AbstractPublication.php');
addAutoload('AbstractStatus',					'publisher/AbstractStatus.php');
...
addAutoload('UnknownKeyException',				'publisher/UnknownKeyException.php');
